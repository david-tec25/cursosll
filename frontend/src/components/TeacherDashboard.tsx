...
export const TeacherDashboard: React.FC<TeacherDashboardProps> = ({
  ...
  // Sync selectedTeacherId if role is teacher
  useEffect(() => {
    if (userRole === 'teacher' && defaultTeacher) {
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-12">
      {/* Teacher Switcher Header (3 buttons, one for each primary teacher, only for admin) */}
      {userRole !== 'teacher' && (
