...
export const TeacherDashboard: React.FC<TeacherDashboardProps> = ({
  ...
  const classroomStatus = roomConflicts.length > 0 
    ? 'Conflicto Detectado' 
      ...
      {roomConflicts.length > 0 && (
        <section className="bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 p-4 rounded-2xl flex items-start gap-3 animate-pulse">
          ...
          <div className="space-y-1">
            <h4 className="font-extrabold text-sm text-red-900 dark:text-red-200">Alertas de Aula Detectadas ({roomConflicts.length})</h4>
            ...
            <div className="mt-2 space-y-1">
              {roomConflicts.map((conflict) => (
                <div key={conflict.id} className="text-xs font-semibold text-red-800 dark:text-red-200 bg-white/50 dark:bg-red-900/40 px-3 py-1 rounded-lg inline-block mr-2 mt-1">
